...
def healing_potion() -> str:
    """Combine fire and water string outputs into a formatted result."""
...
def strength_potion() -> str:
    """Combine earth and fire string outputs into a formatted result."""
...
def invisibility_potion() -> str:
    """Combine air and water string outputs into a formatted result."""
...
def wisdom_potion() -> str:
    """Aggregate all four elemental string outputs into a single result."""
    f = create_fire()
    wa = create_water()
    e = create_earth()
    a = create_air()
